...
class PriceHelper_2012e62 extends \Sylius\Bundle\CoreBundle\Templating\Helper\PriceHelper implements \ProxyManager\Proxy\VirtualProxyInterface
{
    ...
    {
        $this->initializer4c871 && ($this->initializer4c871->__invoke($valueHolder3721e, $this, 'getPrice', array('productVariant' => $productVariant, 'context' => $context), $this->initializer4c871) || 1) && $this->valueHolder3721e = $valueHolder3721e;

        return $this->valueHolder3721e->getPrice($productVariant, $context);
    }

    public function getOriginalPrice(\Sylius\Component\Core\Model\ProductVariantInterface $productVariant, array $context) : int
    {
        $this->initializer4c871 && ($this->initializer4c871->__invoke($valueHolder3721e, $this, 'getOriginalPrice', array('productVariant' => $productVariant, 'context' => $context), $this->initializer4c871) || 1) && $this->valueHolder3721e = $valueHolder3721e;

        return $this->valueHolder3721e->getOriginalPrice($productVariant, $context);
    }

    public function hasDiscount(\Sylius\Component\Core\Model\ProductVariantInterface $productVariant, array $context) : bool
    {
        $this->initializer4c871 && ($this->initializer4c871->__invoke($valueHolder3721e, $this, 'hasDiscount', array('productVariant' => $productVariant, 'context' => $context), $this->initializer4c871) || 1) && $this->valueHolder3721e = $valueHolder3721e;

        return $this->valueHolder3721e->hasDiscount($productVariant, $context);
    }
    ...
    public function __construct(\Sylius\Component\Core\Calculator\ProductVariantPriceCalculatorInterface $productVariantPriceCalculator)
    {
        ...
        $this->valueHolder3721e->__construct($productVariantPriceCalculator);
    }
