...
class getSyliusFixtures_FixtureRegistryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->addFixture(($container->services['sylius.fixture.api_client'] ?? $container->load('getSylius_Fixture_ApiClientService')));
        $instance->addFixture(($container->services['sylius.fixture.api_access_token'] ?? $container->load('getSylius_Fixture_ApiAccessTokenService')));
